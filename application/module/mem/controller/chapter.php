...
use \App\Model\Book as Model_Chapter;
use \Zx\View\View;
use \Zx\Test\Test;

class Chapter extends Mem {

    public $list_page = '';
    public function init() {
        $this->view_path = APPLICATION_PATH . 'module/mem/view/chapter/';
        $this->list_page =  MEM_HTML_ROOT . 'chapter/retrieve/1/title/ASC/';
    ...
    public function create() {
        ...
        if ($success) {
            ...
            $books = Model_Book::get_all_books_by_author_id($this->user_id);
